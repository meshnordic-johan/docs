...
<ResponseField name="Bundle" type="boolean">
...
<ResponseField name="Add-to-cart product ID" type="string">
Used when adding items to cart on the frontend. Example value: ABC1234.

<ResponseField name="Cost of goods sold" type="float">
